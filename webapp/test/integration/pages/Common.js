sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("gdprcockpit/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("gdprcockpit.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["gdprcockpit/localService/mockserver"], function (mockserver) {
